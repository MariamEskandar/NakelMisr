...
*/
    ...
    public UserInformation(String Type,String Name, String National_Number,String Phone_Number,String Car_Number,String License_Number,String photo,String photo_id) {
        this.Type = Type;
        this.Name = Name;
    ...
    public UserInformation(String type, String name, String national_Number, String phone_Number,String photo_id) {
        Type = type;
        Name = name;
