...
import animal.nakel.com.nakel.R;

public class Public_Profile_Taxi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_public__profile__taxi);
...
//.child(mPublic_Profile_tkey)
        ...
        mDatabase.child(mPublic_Profile_tkey).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
             ...
             //   Picasso.with(Public_Profile_Taxi.this).load(photo).into(imageViewDownload);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            if(getActivity.equals("1")) {
                Intent intent = new Intent(Public_Profile_Taxi.this, Accept_Request.class);
                startActivity(intent);

            }
            if(getActivity.equals("2")) {
                Intent intent = new Intent(Public_Profile_Taxi.this, Accept_Request_Taxi.class);
                startActivity(intent);
